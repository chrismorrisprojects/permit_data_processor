...
DATA_DIR = 'texas/drillMasterDatabase/'
naDate = '1800-01-01'
dateFmt = "%Y%m%d"
...
if __name__ == "__main__":
    file = open(f'{BASE_DIR}{DATA_DIR}daf804.txt', 'r')
    daMainDF = pd.read_fwf(file, colspecs=colSpecs, names=colNames, converters={34:str, 35:str})
